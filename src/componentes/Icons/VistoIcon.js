...
const VistoIcon = (props) => {
    return (
        <svg fill={props.fill} xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 417.065 417.065" space="preserve">
            <g>
